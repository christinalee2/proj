        ...
        fields=[
            ...
            FieldConfig('institution_type_layer1', 'Type Layer 1', 'select', category='main',
                       detailed_help="""
                        ...
                        |----------|------------|----------|
                        | Public | Organisations that are majority-owned >50% or effectively controlled by a government or public authority. This includes central, regional, or local governments, state-owned enterprises and financial institutions, and multilateral, bilateral, and national development finance institutions. | Ministries, central banks, sovereign wealth funds, state-owned utilities, public universities, multilateral DFIs (e.g., World Bank, AfDB) |
