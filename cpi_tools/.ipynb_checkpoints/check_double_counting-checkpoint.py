"""
Double-counting detection and deduplication module for climate finance data.

This module provides functionality to identify and remove duplicate projects across
different climate finance data sources using fuzzy matching algorithms and validation workflows.
"""
