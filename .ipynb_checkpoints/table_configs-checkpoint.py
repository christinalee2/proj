...
TABLE_CONFIGS = {
    ...
    'instrument': TableConfig(
        ...
        fields=[
            FieldConfig('instrument_original', 'Original Instrument Name (from source)', 'text', required=True,
                       help_text='Type of financial instrument',
                       placeholder='Enter instrument name...'),
            FieldConfig('instrument_type', 'Instrument Type', 'text', required=True,
                       help_text='Type of financial instrument',
                       placeholder='Enter instrument type...'),
            FieldConfig('instrument_type_layer2', 'Type Layer 2', 'select', category='main'),
            FieldConfig('instrument_concessional', 'Concessional', 'select', category='main'),
    ...
    'gearing': TableConfig(
        ...
        fields=[
            FieldConfig('sector_re', 'Sector', 'select', required=True,
                       help_text='Sector'),
    ...
    'multiplier': TableConfig(
        ...
        fields=[
            FieldConfig('multiplier_local', 'Multiplier', 'text', required=True),
